...
public class GamemodeManager {
  ...
  public void tickGamemode() {
    if (!gamemode.getBoolean("gameOver")) {
      ...
      console.print(
          "Currently the only way to reset for a new game is to close the server and delete the world root folder");
  ...
  private void loadAllGamemodes() {
    try (ScanResult scanResult = new ClassGraph().acceptPackages("gamemode").scan()) {
